defmodule Personal.HomePage do
  ...
  def template(assigns) do
    ...
    <p>
      Earlier in my career, I trained as a quantitative social scientist at Princeton University, worked at a think tank, and consulted for organizations like the UN and World Bank on issues related to Fragility, Conflict, and Violence.
    </p>
    <br />
